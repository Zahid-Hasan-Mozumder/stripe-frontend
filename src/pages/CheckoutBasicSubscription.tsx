...
function CheckoutBasicSubscription() {
    ...
    const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
        ...
        const response = await axios.post('http://localhost:3000/payment/basic',
            {
...
export default CheckoutBasicSubscription